package org.apache.royale.community.echarts
{
    import org.apache.royale.community.echarts.events.EChartsEvent;
    import org.apache.royale.community.echarts.vos.EChartsInstanceVO;
    COMPILE::JS{
    ...
    import org.apache.royale.community.echarts.vos.EChartsThemeTemplateVO;

    /**
     *  Indicates that the initialization of the EChartsInstance is complete.
     */
	[Event(name="onCompleteInicialize", type="org.apache.royale.community.echarts.events.EChartsEvent")]

    /**
     *  Indicates that the current EChartsInstance has been disposed.
     */
	[Event(name="onDisposeInstance", type="org.apache.royale.community.echarts.events.EChartsEvent")]
    /**
     *  Indicates that the configuration of the EChartsInstance is complete.
     */
	[Event(name="onCompleteConfig", type="org.apache.royale.community.echarts.events.EChartsEvent")]
    /**
     *  indicates that the update of the configuration of the EChartsInstance is complete
     */
	[Event(name="onUpdateConfig", type="org.apache.royale.community.echarts.events.EChartsEvent")]
	...
	public class EChartsBasicControl extends UIBase implements IEChartsBasic
    {
		...
		public function init(make:Boolean = false):void
		{
			...
			// see org.apache.royale.community.echarts.init
             COMPILE::JS{
		...
		/**
		 * Group name to be used in org.apache.royale.community.echarts.connection
		 */
