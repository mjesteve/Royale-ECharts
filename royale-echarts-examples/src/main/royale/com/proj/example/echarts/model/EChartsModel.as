package com.proj.example.echarts.model
{
    ...
    public class EChartsModel extends EventDispatcher implements IBeadModel
	{
		...
		private var _withThemesSupport:Boolean = false;
		...
		public function get themesLoadArrayList():ArrayList
		{
		...
		public function itemTheme(themeName:String):EChartsThemeTemplateVO
		{
